const getClienteById = (id) => {
  ...
  const url = id > 0 ? `https://apidev17.azurewebsites.net/Clientes/Listar/${id}` : `https://apidev17.azurewebsites.net/Clientes/Listar/All`;
    setTimeout(() => {
      axios.get(url)
        .then(response => {
...
const deleteClienteById = () => {
  axios.delete(`https://apidev17.azurewebsites.net/Clientes/Deletar/${id.value}`)
  .then(response => {
    alert(response.data);
    getClienteById(0);
  })
...
const updateClienteById = () => {
  axios.put(`https://apidev17.azurewebsites.net/Clientes/Atualizar/${id.value}`, {
    nome : nome.value,
    cpf : cpf.value,
...
const insertCliente = () => {
  axios.post(`https://apidev17.azurewebsites.net/Clientes/Incluir`, [
    {
      nome : nome.value,
      cpf : cpf.value,
      nascimento : nascimento.value
